...
require_once ('custom/modules/Leads/views/reed_Handler.php');
require_once ('custom/modules/Leads/import_xml/ImportReed.class.php');
...
$_REQUEST ['xml_source'] = "reed";
$_REQUEST ['import_module'] = 'Leads';
$file_stream = "";

// Validate Reed XML file.
$xmlHandler = new Reed_Handler();
...
$error_file = $process_path . $current_user->id . "_reed_process_error";
...
$importXMLObj = new ImportReed($xmlHandler->parseVals,$status_filename);
