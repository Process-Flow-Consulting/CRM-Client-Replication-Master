<?php /* Smarty version 2.6.31, created on 2020-12-11 03:36:03
...
' autocomplete="off">
           ...
           <!-- <br>
			<input type="checkbox" name="tnc" id="tnc" value="1">		
					&nbsp;I accept the <a style="text-decoration:none;" target="_blank" href="http://www.thebluebook.com/2011/index.php?id=107">Terms of use and Privacy Policy.</a>
            <br> -->
			<br>
...
" autocomplete="off">
    ...
    <div class="p_login_bottom">
			...
			View&nbsp;<a style="text-decoration:none;float:right;" target="_blank" href="http://www.thebluebook.com/2011/index.php?id=107">Terms of use and Privacy Policy.</a></div>
	</div>
