                ...
                <ul class="nav navbar-nav">
                    <li class="navbar-brand-container">
                            <a class="navbar-brand with-home-icon" href="index.php?module=Home&action=index">
								<img src="themes/SuiteP/images/p_login_logo.png">
							</a>
                    </li>
...
"<?php endif; ?>><?php echo $this->_tpl_vars['GCL']['LABEL']; ?>
                        ...
                        <?php endforeach; endif; unset($_from); ?>
						<li role="presentation"><a href="index.php?module=Home&action=OutlookPlugin">Outlook Plugin</a></li>
