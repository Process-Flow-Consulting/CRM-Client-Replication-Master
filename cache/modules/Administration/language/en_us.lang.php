...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_BLUE_BOOK_INFO_TITLE' => 'Project Pipeline Configuration',
  'LBL_BLUE_BOOK_INFO_DISC' => 'Define Instance Configurations.',
  'LNK_BLUE_BOOK' => 'Project Pipeline Configuration',
  'LBL_BLUE_BOOK_INFO' => 'Manage Project Pipeline Configuration',
  'LNK_INSTANCE' => 'Instance Info',
  'LBL_INSTANCE_INFO' => 'Manage Instance Info',
  'LNK_GEO_FILTERS' => 'Reset Filters',
  'LNK_GEO_FILTERS_INFO' => 'Manage Filters',
  'LNK_TARGET_CLASS_INST' => 'Reset Target Classifications',
  'LNK_TARGET_CLASS_INST_DISC' => 'Manage Target Classifications',
  'LNK_FILTER_CLASS_DISC' => 'Manage Filters & Target Classifications.',
  'LBL_REPORTS_TITLE' => 'Project Pipeline Reports',
  'LNK_REPORT_DISC' => 'Manage Project Pipeline Reports',
  'LNK_CREATE_REPORT' => 'Create Report',
  'LNK_CREATE_REPORT_INFO' => 'Create a Project Pipeline Report',
  'LNK_SEARCH_SETTINGS' => 'Search Setting',
  'LNK_SEARCH_SETTINGS_DESC' => 'Search Configuration',
  'LNK_CREATE_ZONE' => 'Zone Management',
  'LNK_CREATE_ZONE_INFO' => 'Create a Project Pipeline Zone',
  'LNK_IMPORT_MAP_SETTINGS' => 'Project Lead Import Maps',
  'LNK_IMPORT_MAP_SETTINGS_INFO' => 'Manage Project Leads Import CSV Mapping .',
  'LBL_DELETE_PREVIOUS_MAPPINGS' => 'Delete Previous Mappings',
  'LBL_CREATE_NEW_MAPPING' => ' Create New Mapping',
  'LBL_MANAGE_MAPPING' => 'Manage Import Mapping',
  'LBL_SELECT_MAPPINGS' => 'Select Mappings',
  'LBL_OPT_TO_SELECT' => 'Please select an option to proceed.',
  'LBL_CONFIRM_DELETE_MAP' => 'This will delete the selected Project Leads import CSV mapping(s). Are you sure to delete the selected mapping(s)?',
  'LBL_SEL_DELETE_MAP' => 'Please select an item to be deleted.',
  'LNK_UPDATE_QUOTE_NUMBER' => 'Reset Proposal Number',
  'LNK_UPDATE_QUOTE_NUMBER_INFO' => 'Reset Proposal Auto Increment Number',
  'LBL_NEW_PROPOSAL_NUMBER' => 'New Proposal Number',
  'LBL_MODIFY_PROPOSAL_NUMBER' => 'Reset Proposal Number',
  'LBL_ALERT_PROPOSAL_NUMBER' => 'New Proposal number must be greater then the Old Proposal Number',
  'LBL_NEW_PROPOSAL_NUMBER_NOTICE' => 'Proposal Number is an auto incremented field in "Proposal" module and currently it is displaying default auto increment value, Once you increase it then you can not decrease it.',
  'LBL_BLUE_BOOK_QUICKBOOKs_CONFIGURATION' => 'Project Pipeline QuickBooks Configuration',
  'LBL_BLUE_BOOK_QUICKBOOKs_CONFIGURATION_MANAGE' => 'Manage Project Pipeline QuickBooks Configuration',
  'LNK_UPDATE_PRODUCT_TEMPLATE' => 'Update Product Catalog',
  'LNK_UPDATE_PRODUCT_TEMPLATE_INFO' => 'Enable/Disable Product Catalog Add/Edit.',
  'LBL_UPDATE_PRODUCT_TEMPLATE_PERMISSION' => 'Update Product Catalog Permission',
  'LBL_UPDATE_PRODUCT_TEMPLATE_PERMISSION_FLAG' => 'Disable Product Catalog Configuration',
  'LBL_UPDATE_PRODUCT_TEMPLATE_PERMISSION_FLAG_NAME' => 'Disable Product Catalog Add/Edit',
  'LNK_UPDATE_QUICKBOOKS_IMPORT_CONFIGURATION' => 'QuickBooks Import/Update  Configuration',
  'LBL_UPDATE_QUICKBOOKS_IMPORT_CONFIGURATION' => 'Update QuickBooks Import/Update Configuration',
  'LNK_IMPORT_CLIENT_FLAG' => 'Clients Import from QuickBooks',
  'LNK_IMPORT_CLIENT_CONTACTS_FLAG' => 'Client Contacts Import from QuickBooks',
  'LNK_IMPORT_PRODUCTS_CATALOG_FLAG' => 'Product Catalog Import Settings',
  'LBL_IMPORT_SETTING' => 'Import Settings',
  'LBL_UPDATE_QUICKBOOKS_SETTINGS' => 'QuickBooks Import Settings',
  'LBL_INVENTORY_IMPORT_SETTING' => 'Inventory Import from QuickBooks',
  'LBL_NON_INVENTORY_IMPORT_SETTING' => 'Non Inventory Import from QuickBooks',
  'LNK_QUICKBOOKS_CONNECTOR' => 'QuickBooks Connectors',
  'LBL_QUICKBOOKS_CONNECTOR_DESC' => 'Download Quickbooks Connectors',
  'LBL_QUICKBOOKS_CONNECTORS' => 'Download QuickBooks Connectors',
  'LNK_IMPORT_UNIT_OF_MEASURE_FLAG' => 'Unit Of Measure Import from QuickBooks',
  'LNK_UPDATE_UNIT_OF_MEASURE' => 'Update Unit Of Measure',
  'LNK_UPDATE_UNIT_OF_MEASURE_INFO' => 'Update Unit Of Measure Settings.',
  'LBL_UPDATE_UNIT_OF_MEASURE' => 'Update Unit Of Measure Settings',
  'LBL_UPDATE_UNIT_OF_MEASURE_SETTINGS' => 'Unit Of Measure',
  'LBL_UNIT_OF_MEASURE_QUICKBOOKS' => 'Quickbooks',
  'LBL_UNIT_OF_MEASURE_PROJECT_PIPELINE' => 'Project Pipeline',
  'LBL_UNIT_OF_MEASURE_CUSTOM' => 'Custom',
  'LNK_IMPORT_SALES_TAX_FLAG' => 'Sales Tax Import from QuickBooks',
  'LNK_UPDATE_SALESTAX' => 'Update Sales Tax',
  'LNK_UPDATE_SALES_TAX_INFO' => 'Update Sales Tax Settings',
  'LBL_UPDATE_SALES_TAX_SETTINGS' => 'Sales Tax Configuration - Proposal',
  'LBL_UPDATE_SALES_TAX_SETTINGS_INFO' => 'Update Sales Tax Settings',
  'LBL_UPDATE_SALES_TAX_SETTINGS_NAME' => 'Sales Tax',
  'LBL_SALES_TAX_PER_ITEM' => 'Per Line Item',
  'LBL_SALES_TAX_ALL_ITEM' => 'Total Amount Based on Selected Tax Rate',
  'LNK_INSERT_UNIT_OF_MEASURE' => 'Unit of Measure',
  'LBL_INSERT_UNIT_OF_MEASURE' => 'Enter items in the unit of measure',
  'LBL_PROPOSAL_CONFIGURATION' => 'Proposal Configuration',
  'LBL_BLUE_BOOK_CUSTOM_FIELDS' => 'Project Pipeline Custom Fields',
  'LBL_BLUE_BOOK_CUSTOM_FIELDS_MANAGE' => 'Manage Project Pipeline Custom Fields',
  'LNK_CREATE_CUSTOM_FIELDS' => 'Create Custom Fields',
  'LNK_CREATE_CUSTOM_FIELDS_INFO' => 'Create Custom Fields',
  'LBL_CREATE_CUSTOM_FIELDS' => 'Custom Field Configurator',
  'LBL_CREATE_CUSTOM_FIELDS_SETTINGS_INFO' => 'Define your own custom fields for Clients,Client Contacts, Project Lead, Opportunities. Each module can have upto 12 fields.',
  'LBL_CREATE_EDIT_CUSTOM_FIELDS' => 'Create/Edit Field',
  'LBL_CREATE_EDIT_CUSTOM_FIELDS_MODULE' => 'Module',
  'LBL_MODULE_ACCOUNTS' => 'Clients',
  'LBL_MODULE_CONTACTS' => 'Client Contacts',
  'LBL_MODULE_LEADS' => 'Project Leads',
  'LBL_MODULE_OPPORTUNITIES' => 'Opportunities',
  'LBL_CREATE_LABEL' => 'Label',
  'LBL_TYPE_DROPDOWN' => 'Dropdown',
  'LBL_TYPE_TEXT' => 'Text',
  'LBL_CREATE_TYPE' => 'Type',
  'LBL_CREATE_ADD_VALUE' => 'Add Value',
  'LBL_CREATE_REMOVE_VALUE' => 'Remove Value',
  'LBL_ADD_TO_ADVANCE_SEARCH' => 'Add to Advanced Search',
  'LNK_VIEW_CUSTOM_FIELDS' => 'View Custom Fields',
  'LNK_VIEW_CUSTOM_FIELDS_INFO' => 'Create/View Custom Fields',
  'LBL_MODULE_CLIENTS' => 'Clients',
  'LBL_MODULE_CLIENT_CONTACTS' => 'Client Contacts',
  'LBL_MODULE_PROJECT_LEAD' => 'Project Leads',
  'LBL_MODULE_OPPORTUNITY_PARENT' => 'Project Opportunity',
  'LBL_MODULE_OPPORTUNITY_CLIENT' => 'Client Opportunity',
  'LBL_FIELD_NAME' => 'Field Name',
  'LBL_FIELD_TYPE' => 'Field Type',
  'LBL_CUSTOM_EDIT' => 'Edit',
  'LBL_CUSTOM_DELETE' => 'Delete',
  'LBL_SERIAL_NUMBER' => 'S.No',
  'LBL_OPPORTUNITY_TYPE' => 'Opportunity Type',
  'LBL_CLIENT_OPPORTUNITY' => 'Client Opportunity',
  'LBL_PARENT_OPPORTUNITY' => 'Project Opportunity',
  'LBL_CUSTOM_VALIDATION' => 'Required',
  'LBL_CANCEL_CUSTOM_FIELDS' => 'Cancel',
  'LBL_ADVANCE_SEARCH' => 'Advance Search',
  'LBL_VALUE_EXISTS' => 'Already Exists',
  'LBL_ALPHANUMERIC_ERROR' => 'Only Alphanumeric value allowed',
  'LBL_NO_VALUE_ERROR' => 'No Value Added',
  'LBL_MAX_8_VALUE_ERROR' => 'Only 12 Custom Fields are allowed per module',
  'LBL_HEADER_DESCRIPTION' => 'Welcome to the Custom Field Configurator. Only 8 Custom Fields are allowed per module.',
  'LBL_FIELD_REPAIR_ERROR' => 'There is a problem while creating the field. Please click on Repair to create the field.',
  'LBL_UPDATE_QUICKBOOKS_SYNC_CONFIGURATION' => 'QuickBooks Sync Configuration',
  'LBL_QUICKBOOKS_PROJECT_PIPELINE' => 'QuickBooks To ProjectPipeline Configuration',
  'LBL_PROJECT_PIPELINE_QUICKBOOKS' => 'ProjectPipeline To QuickBooks Configuration',
  'LBL_QUICKBOOKS_MASTER_CONFIGURATION' => 'Master Configuration',
  'LBL_QUICKBOOKS_OPPORTUNITY_AUTO_TRIGGER_CONFIGURATION' => 'Opportunity Auto Trigger Configuration',
  'LBL_QUICKBOOKS_CUSTOMER' => 'Customer',
  'LBL_QUICKBOOKS_JOBS' => 'Jobs',
  'LBL_QUICKBOOKS_INVENTORY' => 'Inventory',
  'LBL_QUICKBOOKS_PROPOSAL' => 'Proposal',
  'LBL_QUICKBOOKS_PRIORITY' => 'Which Record Has Highest Priority ?',
  'LBL_QUICKBOOKS_SYNC_CONFIG_MANUAL' => 'Custom Trigger',
  'LBL_QUICKBOOKS_SYNC_CONFIG_AUTO' => 'Default Trigger',
  'LBL_QUICKBOOKS_OPPORTUNITY_TRIGGER' => 'Opportunity Trigger',
  'LBL_QUICKBOOKS_SYNC_ERROR1' => 'Do Not sync Cannot be selected as Client Opportunity is not Do Not Sync',
  'LBL_QUICKBOOKS_SYNC_ERROR2' => 'Do Not sync Cannot be selected as Client Opportunity and Proposal is not Do Not Sync',
  'LBL_QUICKBOOKS_SYNC_ERROR3' => 'Do Not sync Cannot be selected as Proposal is not Do Not Sync',
  'LBL_QUICKBOOKS_SYNC_ERROR4' => 'Do Not sync Cannot be selected as Job and Proposal is not Do Not Sync',
  'LBL_QUICKBOOKS_SYNC_ERROR5' => 'Do Not sync Cannot be selected as Job is not Do Not Sync',
  'LNK_MAPPING_CONFIGURATION' => 'Mapping Configuration',
  'LBL_MAPPING_CONFIGURATION' => 'Mapping Configuration',
  'LBL_DEFAULT_MAPPING' => 'Default Mapping',
  'LBL_CUSTOM_MAPPING' => 'Custom Mapping',
  'LBL_CUSTOM_MAPPING_CONFIGURATION' => 'Custom Mapping Configuration',
  'LBL_FIELDS_MAPPING' => 'Fields Mapping',
  'LBL_FIELDS' => 'Fields',
  'LBL_ESTIMATE_FIELDS' => 'Estimate',
  'LBL_INVOICE_FIELDS' => 'InVoice',
  'LBL_CUSTOMERNAME' => 'Customer Name',
  'LBL_CUSTOMERBILLADDRESS_ADDR1' => 'Billing Address 1',
  'LBL_CUSTOMERBILLADDRESS_ADDR2' => 'Billing Address 2',
  'LBL_CUSTOMERBILLADDRESS_CITY' => 'City',
  'LBL_CUSTOMERBILLADDRESS_STATE' => 'State',
  'LBL_CUSTOMERBILLADDRESS_POSTALCODE' => 'Postal Code',
  'LBL_CUSTOMERPHONE' => 'Phone',
  'LBL_CUSTOMERFAX' => 'Fax',
  'LBL_CUSTOMEREMAIL' => 'Email',
  'LBL_CUSTOMERADDITIONALCONTACTREF_CONTACTNAME_WEBSITE' => 'Website',
  'LBL_JOBNAME' => 'Job Name',
  'LBL_JOBJOBSTATUS' => 'Bid Status',
  'LBL_JOBJOBPROJECTEDENDDATE' => 'Bids Due',
  'LBL_INVENTORYNAME' => 'Product Name',
  'LBL_INVENTORYMANUFACTURERPARTNUMBER' => 'Manufacturer Part Number',
  'LBL_MANUFACTURERPARTNUMBER' => 'Manufacturer Part Number',
  'LBL_INVENTORYUNITOFMEASURESETREF_LISTID' => 'Unit Of Measure',
  'LBL_INVENTORYSALESTAXCODEREF_FULLNAME' => 'Sales Tax',
  'LBL_INVENTORYSALESDESC' => 'Sales Tax Description',
  'LBL_INVENTORYSALESPRICE' => 'Sale Price',
  'LBL_INVENTORYPURCHASECOST' => 'Purchase Cost',
  'LBL_INVENTORYQUANTITYONHAND' => 'Quantity',
  'LBL_INVENTORYINCOMEACCOUNTREF_LISTID' => 'Income Account',
  'LBL_INVENTORYCOGSACCOUNTREF_LISTID' => 'COGS Account',
  'LBL_INVENTORYASSETACCOUNTREF_LISTID' => 'Asset Account',
  'LBL_INVENTORYPURCHASEDESC' => 'Purchase Descripton',
  'LBL_INVENTORYEXPENSEACCOUNTREF_LISTID' => 'Expense Account',
  'LBL_ESTIMATEREFNUMBER' => 'Quote Number',
  'LBL_ESTIMATEBILLADDRESS_ADDR1' => 'Street',
  'LBL_ESTIMATEBILLADDRESS_CITY' => 'City',
  'LBL_ESTIMATEBILLADDRESS_STATE' => 'State',
  'LBL_ESTIMATEBILLADDRESS_POSTALCODE' => 'Postal Code',
  'LBL_ESTIMATEDUEDATE' => 'Due Date',
  'LBL_ESTIMATEMEMO' => 'Memo',
  'LBL_ESTIMATELINERET_DESC' => 'Description',
  'LBL_ESTIMATELINERET_QUANTITY' => 'Quantity',
  'LBL_ESTIMATELINERET_UNITOFMEASURE' => 'Unit Of Measure',
  'LBL_ESTIMATELINERET_RATE' => 'Rate',
  'LBL_ESTIMATELINERET_AMOUNT' => 'Amount',
  'LBL_ESTIMATELINERET_SALESTAXCODEREF_FULLNAME' => 'Sales Tax',
  'LBL_ESTIMATELINERET_MARKUPRATE' => 'Mark Up Rate',
  'LBL_ESTIMATELINERET_MARKUPRATEPERCENT' => 'Mark Up Rate Percentage',
  'LBL_ESTIMATETOTALAMOUNT' => 'Total Amount',
  'LBL_ESTIMATESUBTOTAL' => 'Sub Total',
  'LBL_INVOICEREFNUMBER' => 'Quote Number',
  'LBL_INVOICEBILLADDRESS_ADDR1' => 'Street',
  'LBL_INVOICEBILLADDRESS_CITY' => 'City',
  'LBL_INVOICEBILLADDRESS_STATE' => 'State',
  'LBL_INVOICEBILLADDRESS_POSTALCODE' => 'Postal Code',
  'LBL_INVOICEDUEDATE' => 'Due Date',
  'LBL_INVOICEMEMO' => 'Memo',
  'LBL_INVOICELINERET_DESC' => 'Description',
  'LBL_INVOICELINERET_QUANTITY' => 'Quantity',
  'LBL_INVOICELINERET_UNITOFMEASURE' => 'Unit Of Measure',
  'LBL_INVOICELINERET_RATE' => 'Rate',
  'LBL_INVOICELINERET_AMOUNT' => 'Amount',
  'LBL_INVOICELINERET_SALESTAXCODEREF_FULLNAME' => 'Sales Tax',
  'LBL_INVOICESUBTOTAL' => 'Total Amount',
  'LBL_INVOICELINERET_SERIALNUMBER' => 'Serial Number',
  'LBL_PP_ERROR' => 'All Project Pipeline Required Fields are not mapped !',
  'LBL_QB_ERROR' => 'QuickBooks Required Fields cannot be mapped with Do not Map !',
  'LBL_SAVE_CHANGES' => 'Do You Want to Save The Changes You Made ?',
  'LBL_VALID_OPTIONS' => 'Please Select Valid Options to Save the Mapping !!',
  'LBL_JOBJOBSTARTDATE' => 'Start Date',
  'LBL_JOBJOBENDDATE' => 'End Date',
  'LBL_JOBJOBDESC' => 'Job Description',
  'LBL_JOBJOBTYPEREF_FULLNAME' => 'Job Type',
  'LNK_RESET_ROLES_INST' => 'Reset Roles',
  'LNK_RESET_ROLES_INST_DISC' => 'Manage Roles',
  'LBL_TYPE_MULTI_SELECT_DROP_DOWN' => 'Multi Select',
);