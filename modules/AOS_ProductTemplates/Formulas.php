...
// in modules/AOS_ProductTemplates/language/<lang>.lang.php
// FG - No more need to change local file. Added inclusion of custom/modules/AOS_ProductTemplates/formulas/*.php 
//global $price_formulas;

$GLOBALS['price_formulas'] = array(
	//$discount_price manually entered by admin
	'Fixed'=>'modules/AOS_ProductTemplates/formulas/price_fixed.php'

	//Profit Margin: $discount_price = $cost_price * 100 /(100 - $factor) 
	,'ProfitMargin'=>'modules/AOS_ProductTemplates/formulas/price_profit_margin.php'

	//Percentage Markup: $discount_price = $cost_price x (1 + $percentage) 
	,'PercentageMarkup'=>'modules/AOS_ProductTemplates/formulas/price_cost_markup.php'

	//Percentage Discount: $discount_price = $list_price x (1 - $percentage) 
	,'PercentageDiscount'=>'modules/AOS_ProductTemplates/formulas/price_list_discount.php'

	//List: $discount_price = $list_price  
	,'IsList'=>'modules/AOS_ProductTemplates/formulas/price_list.php'
	);

// FG - Bug 44515 - Added inclusion of all .php formula files in custom/modules/AOS_ProductTemplates/formulas (if exists).
...
if (sugar_is_dir("custom/modules/AOS_ProductTemplates/formulas"))
{
    $_files = glob("custom/modules/AOS_ProductTemplates/formulas/*.php");
