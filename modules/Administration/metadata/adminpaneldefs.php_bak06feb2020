...
// BBSMP-107  -- Start
$admin_option_defs['Administration']['sugarpdf']= array('icon_AdminPDF','LBL_SUGARPDF_SETTINGS','LBL_SUGARPDF_SETTINGS_DESC','./index.php?module=Configurator&action=SugarpdfSettings', 'backups');
// BBSMP-107  -- End
...
//product catalog.
$admin_option_defs=array();
$admin_option_defs['Products']['product_catalog']= array('Products','LBL_PRODUCTS_TITLE','LBL_PRODUCTS','./index.php?module=AOS_ProductTemplates&action=ListView','releases');
$admin_option_defs['Products']['manufacturers']= array('AOS_Manufacturers','LBL_MANUFACTURERS_TITLE','LBL_MANUFACTURERS','./index.php?module=AOS_Manufacturers&action=index','releases');
$admin_option_defs['Products']['product_categories']= array('AOS_Product_Categories','LBL_PRODUCT_CATEGORIES_TITLE','LBL_PRODUCT_CATEGORIES','./index.php?module=AOS_Product_Categories&action=index','releases');
$admin_option_defs['Products']['shipping_providers']= array('AOS_Shippers','LBL_SHIPPERS_TITLE','LBL_SHIPPERS','./index.php?module=AOS_Shippers&action=index','releases');
//$admin_option_defs['Products']['product_types']= array('AOS_ProductTypes','LBL_PRODUCT_TYPES_TITLE','LBL_PRODUCT_TYPES','./index.php?module=AOS_ProductTypes&action=index');

$admin_option_defs['Quotes']['tax_rates']= array('AOS_TaxRates','LBL_TAXRATES_TITLE','LBL_TAXRATES','./index.php?module=AOS_TaxRates&action=index','releases');
