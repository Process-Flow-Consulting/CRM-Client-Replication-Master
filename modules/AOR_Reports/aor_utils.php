...
function getPeriodDate($date_time_period_list_selected)
{
    ...
    if ($date_time_period_list_selected == 'today') {
       ...
       $datetime_period = $datetime_period->modify('tomorrow');
    ...
    }elseif ($date_time_period_list_selected == 'last_7_days') {
         $datetime_period = $datetime_period->sub(new DateInterval("P6D"));
    }elseif ($date_time_period_list_selected == 'next_7_days') {
        $datetime_period = new DateTime();
    ...
    }elseif ($date_time_period_list_selected == 'last_30_days') {
        $datetime_period = $datetime_period->sub(new DateInterval("P29D"));
    }elseif ($date_time_period_list_selected == 'next_30_days') {
         $datetime_period = new DateTime();
    }
...
function getPeriodEndDate($dateTimePeriodListSelected)
{
    ...
    switch ($dateTimePeriodListSelected) {
		...
		case 'next_7_days':
			$datetimePeriod = new DateTime();
			$datetimePeriod = $datetimePeriod->add(new DateInterval("P6D"));
            break;
		case 'last_7_days':
            $datetimePeriod = new DateTime();
            break;
		...
		case 'next_30_days':
            $datetimePeriod = new DateTime();
			$datetimePeriod = $datetimePeriod->add(new DateInterval("P29D"));
            break;
        case 'this_quarter':
