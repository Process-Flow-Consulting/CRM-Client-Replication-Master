...
<div class="dashboard">
    ...
    <div class="tab-content">
        {foreach from=$dashboardPages key=tabNum item=tab}
            ...
            {/if}
                <div style="text-align: center;"><img src="themes/SuiteP/images/loading.gif" width="48" height="48" align="baseline" border="0" alt=""></div>
            </div>
        {/foreach}
    </div>
</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="dashletsList">
                    <p style="text-align: center;"><img src="themes/SuiteP/images/loading.gif" width="48" height="48" align="baseline" border="0" alt=""></p>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="text-align: center;"><img src="themes/SuiteP/images/loading.gif" width="48" height="48" align="baseline" border="0" alt=""></p>                </div>
