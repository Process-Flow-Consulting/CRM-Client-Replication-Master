...
<div id="welcome" class="screen">
    ...
    <tr>
        <td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th align="left" scope="row" colspan="4"><img align="left" src='custom/include/images/sugar_md.png' border="0" />
            ...
            <tr>
               ...
               <p> {$MOD.LBL_WIZARD_WELCOME_NOSMTP}</p>
				...
				<div style="position: absolute;top: -20;background-color: white;height: 63px;margin-top: -65px"> 
				<h1 style="color:#255E90">Construction Relationship Management</h1>
					<p style="color:#255E90;padding:11px 0 0 35px">Your Projects. Your Pipeline. Your Way.
					</p>
				</div>
            ...
            <td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="33%" ><slot><input name='phone_work' type="text" tabindex='4' size='20' maxlength='25' value='{sugar_phone_number_format_edit value=$PHONE_WORK}'></slot></td>
                    ...
                    <tr>
                        ...
                        <td  ><slot><input name='phone_mobile' type="text" tabindex='6' size='20' maxlength='25' value='{sugar_phone_number_format_edit value=$PHONE_MOBILE}'></slot></td>
                    ...
                    <tr>
                        <td scope="row"><slot>{$MOD.LBL_FAX_PHONE}:</slot></td>
                        <td  ><slot><input name='phone_fax' type="text" tabindex='6' size='20' maxlength='25' value='{sugar_phone_number_format_edit value=$PHONE_FAX}'></slot></td>
                        <td scope="row" nowrap="nowrap"><slot>{$MOD.LBL_COMPANY}:</slot></td>
                        <td  ><slot><input name='company_name' type="text" tabindex='6' size='30' maxlength='100' value='{$COMPANY_NAME}'></slot></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><slot>
						{*
								<input name='address_state' tabindex='9' size='15' maxlength='100' value='{$ADDRESS_STATE}'></slot></td>
						*}
						<select  name='address_state'  >
							{html_options options=$AR_ALL_STATES selected=$ADDRESS_STATE}
						</select>
                    </tr>
                    <tr>
...
//function ph field validation 
function isValidPhone(phoneStr){if(phoneStr.length==0){return true;}
if(!/^[0-9\-\s]+$/.test(phoneStr)){
	return false
}else if((trim(phoneStr.replace(/-/gi,"").length) > 10) || (trim(phoneStr.replace(/-/gi,"").length) < 10)){
	return false
}
return true}
    ...
    this.changeScreen = function(screen,skipCheck)
    {
        if ( !skipCheck ) {
            ...
            case 'personalinfo':
                ...
                //add ph field validation on users edit view
                if(!isValidPhone(trim(form.phone_work.value))){add_error_style('UserWizard',form.phone_work.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_WORK') +" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}
                if(!isValidPhone(trim(form.phone_mobile.value))){add_error_style('UserWizard',form.phone_mobile.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_MOBILE') +" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}                
                if(!isValidPhone(trim(form.phone_fax.value))){add_error_style('UserWizard',form.phone_fax.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_FAX')+" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}
