...
class UsersViewQuickedit extends ViewQuickEdit
{
     ...
     */
    protected $footerTpl = 'custom/modules/Users/tpls/QuickEditFooter.tpl';
    ...
    function display(){	
		...
		$arAllUsers = $mod->get_full_list("","",0,0);
		foreach($arAllUsers as $obUsers ){
			
			$arAllUserNames[] = $obUsers->user_name;
		
		}
		
		//$this->ev->ss->assign('USER_NAMES',json_decode($arAllUserNames));
		parent::display();
    }
