...
class ViewGetquickeditopportunity extends ViewAjax
{
    /**
        ...
        if(file_exists($editFileName)) {
           ...
           if(class_exists($c)) {
               ...
               if($view->useForSubpanel) {
                    ...
                    * @date 14-Nov-2013
                    * Called for an edit view of opportunity on ajax call from Client conversion to opportunity
                    * start
                    */
                   if (isset($_REQUEST['create_accounts_opportunity']) && $_REQUEST['create_accounts_opportunity']==1) {
                   		$this->ev->defs['templateMeta']['form']['headerTpl'] = '';
                   		$this->ev->defs['templateMeta']['form']['button_location'] = 'none';
                   		$view->ev->formName = $view->ev->view;
                   } else {
