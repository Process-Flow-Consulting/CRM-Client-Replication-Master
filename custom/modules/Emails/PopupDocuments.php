...
require_once  'custom/modules/Documents/DocumentFilterResult.php';

$seed_bean = new Document();


if(isset($_REQUEST['parent_id']) || (isset($_REQUEST['proposal_docs']) && trim($_REQUEST['proposal_docs']) =='1')){
    $seed_bean = new DocumentFilterResult();
}
