...
$module_menu = Array(
    ...
    Array("index.php?module=Import&action=Step1&import_module=AOS_Manufacturers&return_module=AOS_Manufacturers&return_action=index", $mod_strings['LNK_IMPORT_MANUFACTURERS'],"Import"),
	);
