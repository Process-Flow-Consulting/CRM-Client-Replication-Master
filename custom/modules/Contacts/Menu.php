...
global $mod_strings, $app_strings, $sugar_config;
	...
	if(empty($sugar_config['disc_client'])){
		if(ACLController::checkAccess('Contacts', 'list', true))$module_menu[] =Array("index.php?module=AOR_Reports&action=index&view=contacts", $mod_strings['LNK_CONTACT_REPORTS'],"List", 'ContactReports');
	}
    if (ACLController::checkAccess('Contacts', 'import', true)) {
