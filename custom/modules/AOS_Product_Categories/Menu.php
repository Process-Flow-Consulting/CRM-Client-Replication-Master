...
$module_menu = Array(
	...
	Array("index.php?module=AOS_ProductTypes&action=EditView&return_module=AOS_ProductTypes&return_action=DetailView", $mod_strings['LNK_NEW_PRODUCT_TYPE'],"Add","AOS_ProductTypes"),
    Array("index.php?module=Import&action=Step1&import_module=AOS_Product_Categories&return_module=AOS_Product_Categories&return_action=index", $mod_strings['LNK_IMPORT_PRODUCT_CATEGORIES'],"Import"),
	);
