...
{if count($data) == 0}
    ...
    {if $displayEmptyDataMesssages}
        {if strlen($query) == 0}
                ...
                <p class="msg">
                    {$APP.ZONE_MSG_EMPTY_LIST_VIEW_NO_RESULTS|replace:"<item2>":$createLink|replace:"<item3>":$importLink}
                </p>
                <p class="submsg">
                    {$APP.MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG|replace:"<item1>":$APP.ZONE_MODULE_NAME|replace:"<item4>":$helpLink}
                </p>
