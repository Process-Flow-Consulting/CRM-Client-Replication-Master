...
class AdministrationController extends SugarController
{
     ...
     * @date 04-08-2014
     */
    function action_createcustomfields(){
    	$this->view = 'createcustomfields';
    }
    
    /**
     * action for view custom fields
     * @author Shashank Verma
     * @date 04-08-2014
     */
    function action_viewcustomfields(){
    	$this->view = 'viewcustomfields';
    }
	
	function action_manage_import()
    {
        $this->view = 'manage_import';
    }
	
	function action_updatequotenum(){
        $this->view = 'updatequotenum';
    }
