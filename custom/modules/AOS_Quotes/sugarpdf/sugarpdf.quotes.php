...
class AOS_QuotesSugarpdfAOS_Quotes extends Sugarpdf{
    ...
    public function Header() {
        ...
        if (($headerdata['logo']) AND ($headerdata['logo'] != K_BLANK_IMAGE)) {
            ...
            /**
             * default method image of sugar crm called for width and height management
        ...
        $options = array(
            "isheader"=>false,
            "width" => array('data' => '600','blank'=>'400','logo'=>'500'),
            'table' => array("width"=>'1700','border'=>'0'),
        ...
        // Start overwrite
        $this->writeHTMLTable($table, 0, $options);
    }
