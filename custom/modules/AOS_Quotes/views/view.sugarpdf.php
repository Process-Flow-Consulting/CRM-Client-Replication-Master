...
class AOS_QuotesViewSugarpdf extends ViewSugarpdf{
    ...
    function display(){
        ...
        if (isset($_REQUEST['email_action']) && $_REQUEST['email_action']=="EmailLayout") {
            ...
            if($email_id=="") {
                ...
                header("Location: index.php?action=ComposeViewWithPdfTemplate&module=Emails&parent_type=AOS_Quotes&return_module=AOS_Quotes&return_action=DetailView&return_id=".$_REQUEST['record']."&record=$email_id"."&parent_id=".$_REQUEST['record']."&parent_name=".$quote->name);
            }
        }
    ...
    function email_layout ($file_name, $focus) {
        ...
        //parent type, id
        $email_object->parent_type = "AOS_Quotes";
