...
class UsersController extends SugarController
{
	...
	protected function action_bbwizard()
	{
		$this->view = 'bbwizard';
	} 
	
	function action_save_user_filter(){
		$this->view = 'save_user_filter';
	}
	
	function action_mytargetclass(){
		
	    $this->view = 'mytargetclass';
	}
	
	function action_resetmyroles(){
	
	    $this->view = 'resetmyroles';
	}
}
