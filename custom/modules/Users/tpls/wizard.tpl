        ...
        <td>
            ...
            <tr>
               ...
               <p> {$MOD.LBL_WIZARD_WELCOME_NOSMTP}</p>
				...
				<p style="color:#255E90;font-size:16px;font-weight:bold;">Your Projects. Your Pipeline. Your Way.</p>
				</div>
            ...
            <td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="33%" ><span><input name='phone_work' type="text" tabindex='4' size='20' maxlength='25' value='{sugar_phone_number_format_edit value=$PHONE_WORK}'></span></td>
                    ...
                    <tr>
                        ...
                        <td  ><span><input name='phone_mobile' type="text" tabindex='6' size='20' maxlength='25' value='{sugar_phone_number_format_edit value=$PHONE_MOBILE}'></span></td>
                    ...
                    <tr>
                        <td scope="row"><span>{$MOD.LBL_FAX_PHONE}:</span></td>
                        <td  ><span><input name='phone_fax' type="text" tabindex='6' size='20' maxlength='25' value='{sugar_phone_number_format_edit value=$PHONE_FAX}'></span></td>
                        <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_COMPANY}:</span></td>
                        <td  ><span><input name='company_name' type="text" tabindex='6' size='30' maxlength='100' value='{$COMPANY_NAME}'></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><span>
						{*
								<input name='address_state' tabindex='9' size='15' maxlength='100' value='{$ADDRESS_STATE}'></span></td>
						*}
