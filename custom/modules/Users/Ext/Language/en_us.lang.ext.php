...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using Project Pipeline.',
    'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using Project Pipeline.',
    ...
    'LBL_WIZARD_FINISH_TITLE' => 'You are ready to use Project Pipeline!',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
    ...
    'LBL_WIZARD_PERSONALINFO_DESC' => 'Provide information about yourself. The information you provide about yourself will be visible to other Project Pipeline users.<br />Fields marked with <span class="required">*</span> are required.',
    'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies and names to appear in Project Pipeline.',
