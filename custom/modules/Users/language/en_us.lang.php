...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'LBL_REMINDER_TEXT' => 'Set a default for reminders for calls and meetings. Pop-up notifications appear for all invitees using Project Pipeline. Email reminders are sent to all invitees.',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
  ...
  'LBL_BBWIZ_HELP_MSG' => 'The Admin / Master allows full access and control over all CRM functionality. Through the Admin / Master you are able to set up master lead filters, team relationships and customize the user interface. ',
  'LBL_BBWIZ_TITLE' => 'The Blue Book Building & Construction Network CRM.',
  'LBL_TEAM_MANAGER_INFO' => '<b>Team Manager </b>:<slot>The team manager role allows full access to the lead, opportunity and client database for </br>employees assigned to the team manager. In addition, the team manager can assign lead, opportunities and <br>utilities as well as the reporting functionality specific to their assigned employees. However, the team </br>manager role does not have the ability to modify admin settings.</slot>',
  'LBL_FULL_PIPELINE_INFO' => '<b>Full Pipeline Access </b>: <slot>This role allows full access to the lead, opportunity and client database</br> assigned to the user without the ability to modify admin settings.</slot>',
  'LBL_LEAD_REVIEWER_INFO' => '<b>Lead Review and Distributor</b>: <slot>This role allows a team member access exclusively to the project lead </br>database for the purpose of determining which project leads should be converted to opportunities </br>for the sales / estimating staff to bid.',
  'LBL_OPPORTUNITY_REVIEWER_INFO' => '<b>Opportunity and Proposal manager</b> : <slot>This role allows the user access only to the projects that have been </br>determined as bid / sales opportunities. This role provides the ability to review and fulfill all tasks </br>associated with opportunity review and proposal submission.',
  'ERROR_USER_COUNT' => 'Please select users as per the allowed limit.',
  'ERROR_NO_USER_SELECTED' => 'Please select number of users to be created against a role.',
  'LBL_TEAM_MGR' => 'Team Manager',
  'LBL_FULL_PIPELINE' => 'Full Pipeline Access',
  'LBL_LEAD_REVIEW' => 'Lead Review and Distributor',
  'LBL_OPP_REVIEW' => 'Opportunity and Proposal manager',
  'LBL_WIZARD_SKIP' => 'Skip',
  'LBL_CREATE_USER' => 'Create User(s)',
  'LBL_ERROR_USER_NAME_EXISTS' => 'Username is not available.',
  'LBL_STATE_FILTER' => 'State',
  'LBL_COUNTY_FILTER' => 'County',
  'LBL_ZIP_FILTER' => 'Zip Code',
  'LBL_TYPE_FILTER' => 'Type',
  'LBL_CLASSIFICATION_FILTER' => 'Classification',
  'LBL_LABOR_FILTER' => 'Labor',
  'LBL_USER_FILTER_NOTE' => 'As the administrator, you have the ability to choose which project/opportunities your users will be able to see. To begin please select if your organization would like to distribute leads by Project (location,classification) or by Client (location, classification). ',
  'LBL_USER_SELECT_INFO' => 'Please choose a user from the dropdown and set the selected filters below.',
  'LBL_USER_TM_INFO' => 'Please select user(s) if any.which will be assigned as an employee.',
  'LBL_USER_LBL' => 'Users',
  'LBL_GEO_FILTER' => 'Apply the selected geographical filters to ',
  'LBL_USER_FILTER_FINISH' => 'Finish',
  'LBL_USER_FILTER_NEXT' => 'Next',
  'LBL_USER_FILTERS_TITLE' => 'User Filters',
  'ERROR_USER_LIMIT_EXCEED' => 'User limit has been reached to max allowed users.',
  'ERROR_PACKAGE_EXPIRED' => 'Package expired, Please contact support.',
  'ERROR_INVALID_EMAIL' => 'Please enter a valid email address.',
  'MSG_ALL_USER_FILTER_SAVED' => 'All user filters has been saved, You will be redirected to Dashboard .',
  'CNF_FILTER_CHANGED' => '<p> You have elected to switch the assignment of project leads and opportunities from %f% to %t% . This change will reset all filters you have currently assigned. </p><br/><br/><p>To continue, click OK and select the new filters for your team. If you navigate away from the user filter screen before clicking "Finish" for the last user your changes will not be made. These changes will apply for all new project leads and opportunities.<br/><br/> If you have any questions please contact support at 888-303-2243.</p>',
  'LBL_BBWIZ_TITLE_ADDITIONAL_USER' => '<slot>Congratulations you have successfully created the Admin Project Pipeline Building and Construction Network CRM User!</slot><br/>To allow your team to experience the powerful customization and integration of the "Project Pipeline", your company will be allowed <br/>to create up to 3 additional users during your free trial. <br/>Please review the following roles and select up to 3 additional users.',
  'LBL_ADMIN_INFO' => '<b>Administrator </b>: ',
  'LBL_ZIP' => 'Zip',
  'LBL_CONST_REL_MGMT' => 'Construction Relationship Management',
  'LBL_MY_CLS_TXT' => '<p>Thank you for choosing Project Pipeline.</p><p>To help you identify which Project Leads are actually Opportunities for your company.</p><p>Project Pipeline allows you to filter what type of companies you want displayed on project leads based on their classifications.</p><p>Basically, the types of companies you usually sell your products and services to.</p><p>Please select the "Classifications" that fit your "Target Classification(s)".</p>',
  'LBL_ALL_FIELDS_REQUIRED' => 'All Fields are Mandatory.',
  'LBL_NO_TNC' => '<b>Warning!</b> <br><br>You have attempted to log into Project Pipeline without accepting the Blue Book Network\'s Terms of Use and Privacy Policy. Please review the Terms of Use / Privacy Policy by following the link on the log in screen and accept by checking the box. If you have any questions please contact customer support at 888-303-2243. Thank You.',
  'LBL_INACTIVE_INSTANCE' => 'This instance is inactive. Please contact customer support at 888-303-2243. Thank You.',
  'LBL_FOR_CLIENTS_CHK' => 'Apply to Clients/Client Contacts',
  'LBL_ERROR_NO_CHANGE' => 'No change detected.',
  'LBL_NO_GEO_FILTER_DEFINED' => 'Please click "Ok" to set Geo filters for the instance.',
  'LBL_MY_ROLES_TXT' => '<p>Thank you for choosing Project Pipeline.</p><p>To help you identify which Project Leads are actually Opportunities for your company.</p><p>Project Pipeline allows you to filter what type of companies you want displayed on project leads based on their roles.</p><p>Basically, the types of companies you usually sell your products and services to.</p><p>Please select the "Roles" that fit your "Role(s)".</p>',
  'LBL_ROLES_FILTER' => 'Roles',
