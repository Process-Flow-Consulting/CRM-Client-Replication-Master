...
$viewdefs['Users']['EditView'] = array(
    ...
    'panels' => array (
        ...
        'LBL_EMPLOYEE_INFORMATION' => array(
            ...
            array('address_state'=>array('name'=>'address_state',
            							 'customCode'=>'<select name="address_state"  >{html_options options=$AR_STATES selected=$ADDRESS_STATE }</select>'),'address_postalcode'),
