...
var $useForSubpanel = true;
    ...
    function display() {
		...
		$this->ss->assign('SUBTHEMES', 'Blue Book');
        $this->ss->assign('SUBTHEME', 'Blue Book');
...
EOD
		...
		echo"<script>
			$('.yui-nav>li> #tab1 , .yui-nav>li> #tab2 , .yui-nav>li> #tab4, .yui-nav>li> #tab5, .yui-nav>li> #tab6').click(function(){
				$('.user_groups').css('display','none');
			});
	    </script>";
