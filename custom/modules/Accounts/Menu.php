...
if(empty($sugar_config['disc_client'])){
	if(ACLController::checkAccess('Accounts', 'list', true))$module_menu[]=Array("index.php?module=AOR_Reports&action=index&view=accounts", $mod_strings['LNK_ACCOUNT_REPORTS'],"List", 'AccountReports');
}
