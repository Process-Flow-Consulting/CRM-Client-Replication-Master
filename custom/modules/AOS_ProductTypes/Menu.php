...
$module_menu = Array(
    ...
    Array("index.php?module=Import&action=Step1&import_module=AOS_ProductTypes&return_module=AOS_ProductTypes&return_action=index", $mod_strings['LNK_IMPORT_PRODUCT_TYPES'],"Import"),
	);
