...
class AOS_ProductTypesViewEdit extends ViewEdit
{
	...
	public function predisplay(){
		...
		{
			global $db;
			$query = "SELECT id, name FROM aos_producttypes where deleted=0 ";
			if ($status=='Active') {
	...
	public function display(){
		...
		$('#list_order').after('&nbsp;&nbsp;&nbsp;<em>Set the order in which this type will appear in the Product Type dropdown lists</em>');
		</script>";
	}
}
