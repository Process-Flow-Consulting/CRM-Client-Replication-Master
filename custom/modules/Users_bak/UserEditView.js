...
return true}
function checkUserEmailData(){var e=$(".emailaddresses").attr("id"),t=!0;return $("#"+e+" tr td input[type=text]").each(function(e,a){return""!=a.value&&(t=checkUserEmail(a.id,a.value),0==t)?!1:void 0}),t}
function verify_data(form)
{if(checkUserEmailData()==false) {return false;}var isError=!check_form("EditView");if(trim(form.last_name.value)==""){add_error_style('EditView',form.last_name.name,SUGAR.language.get('app_strings','ERR_MISSING_REQUIRED_FIELDS')+SUGAR.language.get('Users','LBL_LIST_NAME'));isError=true;}
...
if(!isValidPhone(trim(form.phone_work.value))){add_error_style('EditView',form.phone_work.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_WORK') +" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}
if(!isValidPhone(trim(form.phone_mobile.value))){add_error_style('EditView',form.phone_mobile.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_MOBILE') +" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}
if(!isValidPhone(trim(form.phone_other.value))){add_error_style('EditView',form.phone_other.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_OTHER')+" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}
if(!isValidPhone(trim(form.phone_fax.value))){add_error_style('EditView',form.phone_fax.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_FAX')+" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}
if(!isValidPhone(trim(form.phone_home.value))){add_error_style('EditView',form.phone_home.name,SUGAR.language.get('app_strings','ERR_INVALID_VALUE')+SUGAR.language.get('Users','LBL_PHONE_HOME')+" (XXX-XXX-XXXX or XXXXXXXXXX)");isError=true;}
