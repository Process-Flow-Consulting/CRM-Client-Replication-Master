									...
									<tr>																				
										<td colspan="2">
											<table width="100%">
												<tr>
													<td width="25%">&nbsp;</td>													
													<td><input type="checkbox" name="tnc" id="tnc" value="1"></td>											
													<td style="font-size:13px;">I accept the <a style="text-decoration:none;" target="_blank" href="http://www.thebluebook.com/2011/index.php?id=107">Terms of <br>use and Privacy Policy.</a></td>
													<td>&nbsp; <input title="{sugar_translate module="Users" label="LBL_LOGIN_BUTTON_TITLE"}"  class="button primary" class="button primary" type="submit" tabindex="3" id="login_button" name="Login" value="{sugar_translate module="Users" label="LBL_LOGIN_BUTTON_LABEL"}"></td>
												</tr>
											</table>										
											</td>
									</tr>
