    ...
    <tr>
        <td>
            <div class="edit view">
				...
				<tr>
                    <th colspan=4  class="centerMiddle" scope="row"style="padding-left: 40%;">                    	                       
                ...
                <tr>
	                ...
	                {html_checkboxes style="padding-bottom: 35px;" name=labor_filters  options=$DOM_LABOUR_OTIONS selected=$LABOUR_OPTOIONS }
	                </td>
