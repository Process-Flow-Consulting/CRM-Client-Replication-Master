...
{if $createdCount > 0}
		...
		{if $PL_IMPORT_STATUS|@count gt 0}
			...
			{/foreach}
		{else}
			All records already exists in the system.
		{/if}	
{else}
	All records already exists in the system.
{/if}
...
{/if} -->
<br>
All bidders associated with the imported project leads are available for immediate review!<br>
Project Pipeline will now begin adding Blue Book Business Intelligence for records lacking Classification, Labor Affiliation, Etc.<br>
to aide in your client qualification and prospecting efforts.<br>   
