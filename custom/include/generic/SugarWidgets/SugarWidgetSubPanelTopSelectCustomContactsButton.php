...
/**
 * Sugae widget subpanel for contacts subpanel
 * @author Mohit Kumar Gupta
 * @date 07 Nov 2013
 */
class SugarWidgetSubPanelTopSelectCustomContactsButton extends SugarWidgetSubPanelTopButton
{
	//button_properties is a collection of properties associated with the widget_class definition. layoutmanager
	function SugarWidgetSubPanelTopSelectCustomContactsButton($button_properties=array())
	{
	...
	function display(&$widget_data)
	{
		...
		$popup_request_data = array(		
			...
			'call_back_function' => 'updateDeafaultContact',
