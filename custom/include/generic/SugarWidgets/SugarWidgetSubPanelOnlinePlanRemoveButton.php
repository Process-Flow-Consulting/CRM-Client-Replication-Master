...
class SugarWidgetSubPanelOnlinePlanRemoveButton extends SugarWidgetField
{
	...
	function displayList(&$layout_def)
	{
		...
		$icon_remove_text = strtolower($app_strings['LBL_ID_FF_REMOVE']);
         ...
         $mi_oss_plans_id = trim($layout_def['fields']['MI_OSS_ONLINEPLANS_ID']);
         
         if(!empty($mi_oss_plans_id))
         	$hideremove = true;
         $linked_field = 'leads_online_plans';
