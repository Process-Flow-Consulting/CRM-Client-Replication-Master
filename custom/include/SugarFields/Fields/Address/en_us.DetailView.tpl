...
{$fields.{{$displayParams.key}}_address_city.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br} {if $module eq 'Contacts' && $fields.international.value eq 1} {$fields.{{$displayParams.key}}_address_state.value} {else} {${{$displayParams.key}}_state|escape:'htmlentitydecode'|strip_tags|url2html|nl2br} {/if} &nbsp;&nbsp;{$fields.{{$displayParams.key}}_address_postalcode.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}<br>
