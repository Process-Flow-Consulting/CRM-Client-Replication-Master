 ...
 * @param Smarty
 */
function smarty_function_sugar_phone_number_format($params, &$smarty)
{
	...
	$rawField = ph_field_clean_text_detail_view($params['value']);
...
function ph_field_clean_text_detail_view($text)
{
